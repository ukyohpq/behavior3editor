...
b3e.editor.CameraSystem=function(e){"use strict";var s=!1,t=0,o=0;this.update=function(s){var t=e.project.get();if(t){var o=t.trees.getSelected();if(o){var a=e._game.keyboard,n=tine.keys;a.isDown(n.CTRL)?a.isPressed(n.UP)?o.view.zoomIn():a.isPressed(n.DOWN)&&o.view.zoomOut():(a.isDown(n.LEFT)?o.x+=s:a.isDown(n.RIGHT)&&(o.x-=s),a.isDown(n.UP)?o.y+=s:a.isDown(n.DOWN)&&(o.y-=s))}}},this.onMouseDown=function(a){if(2===a.nativeEvent.which){var n=e.project.get();if(n){var i=n.trees.getSelected();i&&(e._game.canvas.className+=" grabbing",s=!0,t=e._game.mouse.x-i.x,o=e._game.mouse.y-i.y)}}},this.onMouseMove=function(a){if(s){var n=e.project.get();if(n){var i=n.trees.getSelected();i&&(i.x=e._game.mouse.x-t,i.y=e._game.mouse.y-o)}}},this.onMouseUp=function(a){if(2===a.nativeEvent.which){var n=e.project.get();if(n){var i=n.trees.getSelected();i&&(e._game.canvas.className=e._game.canvas.className.replace(/(?:^|\s)grabbing(?!\S)/g,""),s=!1,t=0,o=0)}}},this.onMouseWheel=function(s){var t=e.project.get();if(t){var o=t.trees.getSelected();o&&s.ctrlKey&&((s.wheelDeltaY||s.deltaY)>0?o.view.zoomIn():o.view.zoomOut())}};var a=this;e._game.stage.on("stagemousedown",this.onMouseDown,this),e._game.stage.on("stagemousemove",this.onMouseMove,this),e._game.stage.on("stagemouseup",this.onMouseUp,this),e._game.canvas.addEventListener("wheel",function(e){a.onMouseWheel(e)},!1),e._game.canvas.addEventListener("mousewheel",function(e){a.onMouseWheel(e)},!1),e._game.canvas.addEventListener("DOMMouseScroll ",function(e){a.onMouseWheel(e)},!1)};
...
angular.module("app",["ui.router","ui.bootstrap","ngAnimate","templates"]).run(["$rootScope","$window","$state",function(e,t,n){e.isDesktop=!!t.process&&!!t.require,e.go=function(e,t){n.go(e,t)}}]).run(["$window","$animate","$location","$document","$timeout","settingsModel","projectModel",function(e,t,n,o,a,i,r){n.path("/"),angular.element(e.editor._game.canvas).attr("b3-drop-node",!0),i.getSettings(),r.getRecentProjects().then(function(e){function n(){a(function(){var e=angular.element(document.getElementById("page-preload"));t.addClass(e,"preload-fade").then(function(){e.remove()})},500)}e.length>0&&e[0].isOpen?r.openProject(e[0].path).then(function(){n()}):n()})}]);
...
!function(){"use strict";function t(t,e,o,n,a,r,s){function c(){y.type=n.type,y.format=n.format;var t=o.editor["export"];"project"===y.type&&"json"===y.format?l(t.projectToData()):"tree"===y.type&&"json"===y.format?l(t.treeToData()):"nodes"===y.type&&"json"===y.format&&l(t.nodesToData())}function l(t){y.data=t,y.compact=JSON3.stringify(t),y.pretty=JSON3.stringify(t,null,2),y.result=y.pretty}function i(){var t=e[0].createRange();t.selectNodeContents(e[0].getElementById("export-result"));var n=o.getSelection();n.removeAllRanges(),n.addRange(t)}function u(){a.saveAs(null,[".b3",".json"]).then(function(t){s.saveAsync(t,y.pretty).then(function(){r.success("File saved","The file has been saved successfully.")})})}function p(){y.result=y.compact}function f(){y.result=y.pretty}var y=this;y.type=null,y.format=null,y.compact="",y.pretty="",y.result=null,y.data=null,y.hideCompact=!1,y.showCompact=p,y.showPretty=f,y.select=i,y.save=u,c()}angular.module("app").controller("ExportController",t),t.$inject=["$scope","$document","$window","$stateParams","dialogService","notificationService","storageService"]}();
!function(){"use strict";function t(t,o,e,a,n,r,i){function s(){d.type=a.type,d.format=a.format}function c(){n.openFile(!1,[".b3",".json"]).then(function(t){i.loadAsync(t).then(function(t){d.data=JSON3.stringify(t,null,2)})})}function l(){var t=o.editor["import"],a=JSON3.parse(d.data);try{"project"===d.type&&"json"===d.format?t.projectAsData(a):"tree"===d.type&&"json"===d.format?t.treeAsData(a):"nodes"===d.type&&"json"===d.format&&t.nodesAsData(a)}catch(n){r.error("Invalid data","The provided data is invalid.")}e.go("editor")}var d=this;d.type=null,d.format=null,d.open=l,d.loadFromFile=c,d.data="",s()}angular.module("app").controller("ImportController",t),t.$inject=["$scope","$window","$state","$stateParams","dialogService","notificationService","storageService"]}();
...
!function(){"use strict";function e(e){function o(o,l,n){o.keytable.heading=n.heading,o.keytable._onChange=e(n.ngChange);var r=n.ngModel;o.$watch(r,function(e){o.keytable.reset(e)})}var l={require:"^ngModel",restrict:"EA",replace:!0,bindToController:!0,controller:"KeyTableController",controllerAs:"keytable",templateUrl:"directives/keytable.html",link:o};return l}function o(e){function o(){if(a.model)for(var e in a.model)n(e,a.model[e],!1);else a.model={}}function l(e){a.rows=[],a.model=e,o()}function n(e,o,l){a.rows.push({key:e,value:o,fixed:l===!0})}function r(e){a.rows.splice(e,1)}function t(){for(var o in a.model)a.model.hasOwnProperty(o)&&delete a.model[o];for(var l=0;l<a.rows.length;l++){var n=a.rows[l];if(n.key){var r=n.value;isNaN(r)||""===r||(r=parseFloat(r)),a.model[n.key]=r,a._onChange&&a._onChange(e)}}}var a=this;a._onChange=null,a.model=e.keytable.model||e.model||null,a.rows=[],a.add=n,a.remove=r,a.change=t,a.reset=l,o()}angular.module("app").directive("b3KeyTable",e).controller("KeyTableController",o),e.$inject=["$parse"],o.$inject=["$scope"]}();
...
!function(){"use strict";function t(t,e,n,r,o,c,a){function i(){r.save(P,g)}function u(t){if(t){for(var e=g.length-1;e>=0;e--)g[e].path===t.path?g.splice(e,1):g[e].isOpen=!1;var n={name:t.name,description:t.description,path:t.path,isOpen:!0};g.splice(0,0,n)}else for(var r=0;r<g.length;r++)g[r].isOpen=!1;i()}function f(t){m=t,u(t),e.$broadcast("dash-projectchanged")}function p(){return t(function(t,e){if(!g){var n;try{n=r.load(P)}catch(o){}n||(n=[]),g=n}t(g)})}function s(e,n){return t(function(t,r){var o={name:n,description:"",data:[],path:e};a.newProject(),o.data=a.exportProject(),d(o).then(function(){f(o),t()})})}function l(){return m}function d(e){return e=e||m,e.data=a.exportProject(),t(function(t,o){n.editor.clearDirty(),r.save(e.path,e),u(e),t()})}function j(e){return t(function(t,n){try{var o=r.load(e);a.openProject(o.data),f(o),t()}catch(c){n(c)}})}function h(){return t(function(t,e){n.editor.clearDirty(),a.closeProject(),f(null),t()})}function v(e){return t(function(t,n){for(var r=0;r<g.length;r++)if(g[r].path===e){g.splice(r,1);break}i(),t()})}var P=o.join(o.getDataPath(),"recents.json"),g=null,m=null,y={getRecentProjects:p,newProject:s,getProject:l,saveProject:d,openProject:j,closeProject:h,removeProject:v};return y}angular.module("app").factory("projectModel",t),t.$inject=["$q","$rootScope","$window","storageService","systemService","localStorageService","editorService"]}();
...
function dialogService(e,n,t,o){function i(e,t,o,i){return i=i||{},i.title=e,i.text=t,i.type=o,i.customClass=o,n(function(e){swal(i,function(){e()})})}function l(t,o,i,l){return l=l||{},l.title=t,l.text=o,l.type=i,l.customClass=i,l.showCancelButton=!0,n(function(n,t){e.swal(l,function(e){e?n():t()})})}function r(e,t,o,i,l){return l=l||{},l.title=e,l.text=t,l.type=o||"input",l.inputPlaceholder=i,l.customClass=o,l.showCancelButton=!0,n(function(e,n){swal(l,function(t){t!==!1?e(t):n(t)})})}function a(e,t){return n(function(n,t){var i=o.dialog.showSaveDialog({title:"Save project as...",defaultPath:e+".b3",filters:[{name:"Behavior3 File",extensions:["b3","json"]},{name:"All Files",extensions:["*"]}]});i?n(i):t()})}function s(e,t){return n(function(n,t){var i=o.dialog.showOpenDialog({title:"Open file...",multiSelections:e,properties:["openFile"],filters:[{name:"Behavior3 File",extensions:["b3","json"]},{name:"All Files",extensions:["*"]}]});i?(e||(i=i[0]),console.log(i),n(i)):t()})}function c(){return n(function(e,n){var t=o.dialog.showOpenDialog({title:"Open directory...",properties:["openDirectory"]});t?e(t):n()})}var u={alert:i,confirm:l,prompt:r,saveAs:a,openFile:s,openDirectory:c};return u}angular.module("app").factory("dialogService",dialogService),dialogService.$inject=["$window","$q","$document","nodejsService"];
...
function nodejsService(e){var r=!!e.require,i=r?e.require("remote"):null,n={ok:r,fs:r?e.require("fs"):null,path:r?e.require("path"):null,dialog:r?i.require("dialog"):null};return n}angular.module("app").factory("nodejsService",nodejsService),nodejsService.$inject=["$window"];
...
function fileStorageService(e){function r(e,r){if("string"!=typeof r)try{r=JSON3.stringify(r)}catch(n){}var t=i.openSync(e+"~","w");i.writeSync(t,r),i.closeSync(t),i.rename(e+"~",e)}function n(e){var r=i.readFileSync(e,"utf-8");try{r=JSON3.parse(r)}catch(n){}return r}function t(e){}var c=e.ok,i=e.fs,a={ok:c,save:r,load:n,remove:t};return a}angular.module("app").factory("fileStorageService",fileStorageService),fileStorageService.$inject=["nodejsService"];
